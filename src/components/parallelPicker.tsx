...
export const parallels = [
  ...
  },
  {
    ...
    current: false,
    color:
      "hover:shadow-blue-600 hover:border-blue-600 dark:hover:border-blue-600 hover:border-2",
  ...
  },
  {
    ...
    current: false,
    color:
      "hover:shadow-red-600 hover:border-red-600 dark:hover:border-red-600 hover:border-2",

...
export const menu = tv({
  slots: {
    ...
    item: 'relative flex cursor-pointer justify-between rounded-md p-2 text-fg outline-none data-[focused]:bg-primary',
...
const MenuItem = ({ children, className, ...props }: ItemProps & { className?: string }) => (
...
export { MenuContent, MenuHeader, MenuItem, MenuSeperator, MenuTrigger, Section };

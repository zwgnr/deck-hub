...
const button = tv({
  ...
  variants: {
    intent: {
      ...
      secondary: 'bg-secondary text-secondary-fg data-[hovered]:bg-secondary/70',
    },
    state: {
      filled: '',
      ghost: '',
  ...
  compoundVariants: [
    {
      intent: 'primary',
      state: 'ghost',
      class: 'border-2 border-primary bg-primary/30 text-fg data-[hovered]:bg-primary',
    },
    {
      intent: 'primary',
      state: 'soft',
    ...
    },
    {
      intent: 'secondary',
      state: 'ghost',
      class: 'border-2 border-secondary bg-secondary/30 data-[hovered]:bg-secondary',
    },
    {
      intent: 'secondary',
      state: 'soft',
...
export const Button = ({ className, size, intent, state, children, ...props }: ButtonProps) => (

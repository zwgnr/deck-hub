...
import { importErrorAtom, parallelChoiceAtom } from "~/lib/atoms";
...
export const ImportErrorMessage = () => {
  ...
  switch (importError.errorCode) {
    ...
    case "tooManyCards":
      errorMessage =
        "Decks may only contain 40 cards. Remove some and try again.";
      break;
    ...
    case "legendaryLimit":
      errorMessage =
        "If a card is Legendary, you may only add one copy of that card per deck.";
      break;
    case "max3":
    ...
    case "syntaxError":
      errorMessage =
        "Code Format Error. Please ensure your deck code is in the correct format.";
      break;
    case "invalidCard":
      errorMessage =
        "One or more cards is in invalid Parallel card and/or in an incorrect format.";
      break;
    default:
      break;
  }
